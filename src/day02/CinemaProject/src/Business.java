...
public class Business {
    ...
    void search(){
        while(true) {
            ...
            System.out.println();
            do {
                System.out.print("What is ur seat?--> ");
                seat = sc.next();

                if (seatVali(seat)) //CALL to validate function
                {
                    break; //or loop = false;
                } else // if function returns false
                {
            ...
            if(!keySet.contains(seat)){
                System.out.println("The seat wasn't booked. Try again later");
                try {
                    Thread.sleep(2000);
                } catch (InterruptedException e) {
                    e.printStackTrace();
    ...
    void changeSeat(){
        while(true){
            ...
            int f = 0;
            if(seat.charAt(0) == 'A' || seat.charAt(0) == 'B') {
                f = (int) (wantedSeat.charAt(0)) - 65;
            }else if(seat.charAt(0) == 'a' || seat.charAt(0) == 'b'){
                f = (int) (wantedSeat.charAt(0)) - 97;
            }//end else if

            int s = Integer.parseInt(String.valueOf(wantedSeat.charAt(1)));
            ...
            System.out.println("------------------------");
            System.out.println("Name: " + name);
            System.out.println("Seat: " + wantedSeat);
            System.out.println("Price: " + parent.get(i).ticketPrice(seat));
            System.out.println("------------------------");
    ...
    void cancel(){
        while(true){
            ...
            Set keySet = map.keySet();
            if(!keySet.contains(seat)){
                System.out.println("The seat wasn't booked. Try again leter");
                try {
                    Thread.sleep(2000);
                } catch (InterruptedException e) {
                    e.printStackTrace();
